...
<div id="main" class="step2">        
    <h1><?php echo _('osTicket Basic Installation');?></h1>
            <p><?php echo _('Please fill out the information below to continue your osTicket installation. All fields are required.');?></p>
            ...
            <form action="install.php" method="post" id="install">
                ...
                <h4 class="head system"><?php echo _('System Settings');?></h4>
                <span class="subhead"><?php echo _('The URL of your helpdesk, its name, and the default system email address');?></span>
                <div class="row">
                    <label><?php echo _('Helpdesk URL');?>:</label>
                    <span><strong><?php echo URL; ?></strong></span>
                </div>
                <div class="row">
                    <label><?php echo _('Helpdesk Name');?>:</label>
                    <input type="text" name="name" size="45" tabindex="1" value="<?php echo $info['name']; ?>">
                    <a class="tip" href="#t1">?</a>
                    <font class="error"><?php echo $errors['name']; ?></font>
                </div>
                <div class="row">
                    <label><?php echo _('Default Email');?>:</label>
                    <input type="text" name="email" size="45" tabindex="2" value="<?php echo $info['email']; ?>">
                    <a class="tip" href="#t2">?</a>
                    <font class="error"><?php echo $errors['email']; ?></font>
                </div>

                <h4 class="head admin"><?php echo _('Admin User');?></h4>
                <span class="subhead"><?php echo _('Your primary administrator account - you can add more users later.');?></span>
                <div class="row">
                ...
                <h4 class="head database"><?php echo _('Database Settings');?></h4>
                <span class="subhead"><?php echo _('Database connection information');?> <font class="error"><?php echo $errors['db']; ?></font></span>
                <div class="row">
                    <label><?php echo _('MySQL Table Prefix');?>:</label>
                ...
                <div class="row">
                    <label><?php echo _('MySQL Hostname');?>:</label>
                ...
                <div class="row">
                    <label><?php echo _('MySQL Database');?>:</label>
                ...
                <div class="row">
                    <label><?php echo _('MySQL Username');?>:</label>
                ...
                <div class="row">
                    <label><?php echo _('MySQL Password');?>:</label>
                ...
                <br>
                <div id="bar">
                    <input class="btn" type="submit" value="<?php echo _('Install Now');?>" tabindex="14">
                </div>
            </form>
    </div>
    <div>
        <p><strong><?php echo _('Need Help?');?></strong> <?php echo _('We provide <u>professional installation services</u> and commercial support.');?> <a target="_blank" href="http://osticket.com/support/professional_services.php"><?php echo _('Learn More!');?></a></p>
    </div>
    <div id="overlay"></div>
    <div id="loading">
        <h4><?php echo _('Doing stuff!');?></h4>
        <?php echo _('Please wait... while we install your new support ticket system!');?>
    </div>

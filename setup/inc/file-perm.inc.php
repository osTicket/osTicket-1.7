...
?>
    <div id="main">
            ...
            <div id="intro">
             <p>
             <?php echo __('osTicket installer requires ability to write to the configuration file <b>include/ost-config.php</b>. ');?>
             </p>
            </div>
            ...
            <ul>
                ...
                <li><b><?php echo __('FTP');?></b>:<br><?php echo __('Using WS_FTP this would be right hand clicking on the fil, selecting chmod, and then giving all permissions to the file.');?></li>

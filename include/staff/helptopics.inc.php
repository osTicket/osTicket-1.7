...
<div style="width:700;padding-top:5px; float:left;">
 <h2><?php echo _('Help Topics');?></h2>
 </div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="helptopics.php?a=add" class="Icon newHelpTopic"><?php echo _('Add New Help Topic');?></a></b></div>
<div class="clear"></div>
...
<input type="hidden" id="action" name="a" value="" >
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>        
            <th width="320"><a <?php echo $name_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=name"><?php echo _('Help Topic');?></a></th>
            <th width="80"><a  <?php echo $status_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=status"><?php echo _('Status');?></a></th>
            <th width="100"><a  <?php echo $type_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=type"><?php echo _('Type');?></a></th>
            <th width="100"><a  <?php echo $priority_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=priority"><?php echo _('Priority');?></a></th>
            <th width="200"><a  <?php echo $dept_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=dept"><?php echo _('Department');?></a></th>
            <th width="150" nowrap><a  <?php echo $updated_sort; ?>href="helptopics.php?<?php echo $qstr; ?>&sort=updated"><?php echo _('Last Updated');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?php echo _('Are you sure want to <b>enable</b> selected help topics?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        <?php echo _('Are you sure want to <b>disable</b>  selected help topics?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo _('Are you sure you want to DELETE selected help topics?');?></strong></font>
        <br><br><?php echo _('Deleted topics CANNOT be recovered.');?>
    </p>

...
<div style="width:700;padding-top:5px; float:left;">
 <h2><?php echo _('Canned Responses');?></h2>
 </div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="canned.php?a=add" class="Icon newReply"><?php echo _('Add New Response');?></a></b></div>
<div class="clear"></div>
<form action="canned.php" method="POST" name="canned">
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>
            <th width="500"><a <?php echo $title_sort; ?> href="canned.php?<?php echo $qstr; ?>&sort=title"><?php echo _('Title');?></a></th>
            <th width="80"><a  <?php echo $status_sort; ?> href="canned.php?<?php echo $qstr; ?>&sort=status"><?php echo _('Status');?></a></th>
            <th width="200"><a  <?php echo $dept_sort; ?> href="canned.php?<?php echo $qstr; ?>&sort=dept"><?php echo _('Department');?></a></th>
            <th width="150" nowrap><a  <?php echo $updated_sort; ?>href="canned.php?<?php echo $qstr; ?>&sort=updated"><?php echo _('Last Updated');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?php echo _('Are you sure want to <b>enable</b> selected canned responses?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        <?php echo _('Are you sure want to <b>disable</b> selected canned responses?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo _('Are you sure you want to DELETE selected canned responses?');?></strong></font>
        <br><br><?php echo _('Deleted items CANNOT be recovered, including any associated attachments.');?>
    </p>

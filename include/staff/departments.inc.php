...
if($res && ($num=db_num_rows($res)))
    $showing=sprintf(_('Showing 1-%1$d of %2$d departments'),$num,$num);
else
    $showing=_('No departments found!');

?>
<div style="width:700;padding-top:5px; float:left;">
 <h2><?php echo _('Departments');?></h2>
 </div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="departments.php?a=add" class="Icon newDepartment"><?php echo _('Add New Department');?></a></b></div>
<div class="clear"></div>
<form action="departments.php" method="POST" name="depts">
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7px">&nbsp;</th>        
            <th width="180"><a <?php echo $name_sort; ?> href="departments.php?<?php echo $qstr; ?>&sort=name"><?php echo _('Name');?></a></th>
            <th width="80"><a  <?php echo $type_sort; ?> href="departments.php?<?php echo $qstr; ?>&sort=type"><?php echo _('Type');?></a></th>
            <th width="70"><a  <?php echo $users_sort; ?>href="departments.php?<?php echo $qstr; ?>&sort=users"><?php echo _('Users');?></a></th>
            <th width="300"><a  <?php echo $email_sort; ?> href="departments.php?<?php echo $qstr; ?>&sort=email"><?php echo _('Email Address');?></a></th>
            <th width="200"><a  <?php echo $manager_sort; ?> href="departments.php?<?php echo $qstr; ?>&sort=manager"><?php echo _('Dept. Manager');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
<p class="centered" id="actions">
    <input class="button" type="submit" name="make_public" value="<?php echo _('Make Public');?>" >
    <input class="button" type="submit" name="make_private" value="<?php echo _('Make Private');?>" >
    <input class="button" type="submit" name="delete" value="<?php echo _('Delete Dept(s)');?>" >
</p>
<?php
endif;
?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="make_public-confirm">
        <?php echo _('Are you sure want to make selected departments <b>public</b>?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="make_private-confirm">
        <?php echo _('Are you sure want to make selected departments <b>private</b>?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo _('Are you sure you want to DELETE selected departments?');?></strong></font>
        <br><br><?php echo _('Deleted departments CANNOT be recovered.');?>
    </p>

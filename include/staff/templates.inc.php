...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?= _('Are you sure want to <b>enable</b> selected templates?')?>
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        <?= _('Are you sure want to <b>disable</b>  selected templates?')?>
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?= _('Are you sure you want to DELETE selected templates?')?></strong></font>
        <br><br><?= _('Deleted templates CANNOT be recovered.')?>
    </p>

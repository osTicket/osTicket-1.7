...
if($res && ($num=db_num_rows($res)))
    $showing=$pageNav->showing().' '._('categories');
else
    $showing=_('No FAQ categories found!');

?>
<div style="width:700;padding-top:5px; float:left;">
 <h2><?php echo _('FAQ Categories');?></h2>
 </div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="categories.php?a=add" class="Icon newCategory"><?php echo _('Add New Category');?></a></b></div>
<div class="clear"></div>
<form action="categories.php" method="POST" name="cat">
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>
            <th width="500"><a <?php echo $name_sort; ?> href="categories.php?<?php echo $qstr; ?>&sort=name"><?php echo _('Name');?></a></th>
            <th width="150"><a  <?php echo $type_sort; ?> href="categories.php?<?php echo $qstr; ?>&sort=type"><?php echo _('Type');?></a></th>
            <th width="80"><a  <?php echo $faqs_sort; ?> href="categories.php?<?php echo $qstr; ?>&sort=faqs"><?php echo _('FAQs');?></a></th>
            <th width="150" nowrap><a  <?php echo $updated_sort; ?>href="categories.php?<?php echo $qstr; ?>&sort=updated"><?php echo _('Last Updated');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
        ...
        if($res && db_num_rows($res)):
            ...
            <tr id="<?php echo $row['category_id']; ?>">
                ...
                <td><?php echo $row['ispublic']?'<b>'._('Public').'</b>':_('Internal'); ?></td>
...
<p class="centered" id="actions">
    ...
    <input class="button" type="submit" name="make_private" value="<?php echo _('Make Internal');?>">
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="make_public-confirm">
        <?php echo _('Are you sure want to make selected categories <b>public</b>?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="make_private-confirm">
        <?php echo _('Are you sure want to make selected categories <b>private</b> (internal)?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo _('Are you sure you want to DELETE selected categories?');?></strong></font>
        <br><br><?php echo _('Deleted entries CANNOT be recovered, including any associated FAQs.');?>
    </p>

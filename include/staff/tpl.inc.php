...
?>
<h2><?php _('Email Template Message') ?> - <span><?php echo $template->getName(); ?></span></h2>
<div style="padding-top:10px;padding-bottom:5px;">
    <form method="get" action="templates.php">
    <input type="hidden" name="id" value="<?php echo $template->getId(); ?>">
    <input type="hidden" name="a" value="manage">
    <?php _('Message Template') ?>:
    <select name="tpl" style="width:300px;">
        <option value="">&mdash; <?php _('Select Setting Group') ?> &mdash;</option>
        <?php
   ...
   <thead>
     <tr>
        <th colspan="2">
            ...
            <em><?php _('Subject and body required.') ?> <a class="tip" href="ticket_variables.txt"><?php _('Supported Variables') ?></a>.</em>
        </th>
     </tr>
    </thead>
    <tbody>
        <tr>
            <td colspan=2>
                <strong><?php _('Message Subject') ?>:</strong> <em><?php _ ('Email message subject') ?></em> <font class="error">*&nbsp;<?php echo $errors['subj']; ?></font><br>
                <input type="text" name="subj" size="60" value="<?php echo $info['subj']; ?>" >
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <strong><?php _('Message Body') ?>:</strong> <em><?php _('Email message body') ?>.</em> <font class="error">*&nbsp;<?php echo $errors['body']; ?></font><br>
...
<p style="padding-left:210px;">
    ...
    <input class="button" type="button" name="cancel" value="<?php _('Cancel Changes') ?>" onclick='window.location.href="templates.php?id=<?php echo $template->getId(); ?>"'>
</p>
</form>

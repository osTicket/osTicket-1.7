<?php
if(!defined('OSTSTAFFINC') || !$thisstaff || !$thisstaff->isStaff()) die(lang('access_denied'));
$qstr='';
...
<div style="width:700; float:left;">
    <form action="directory.php" method="GET" name="filter">
       <input type="text" name="q" value="<?php echo Format::htmlchars($_REQUEST['q']); ?>" >
        ...
        &nbsp;&nbsp;
        <input type="submit" name="submit" value="<?php echo lang('filter'); ?>"/>
    </form>
 </div>
<div class="clear"></div>
<?php
...
<table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="160"><a <?php echo $name_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=name"><?php echo lang('name'); ?></a></th>
            <th width="150"><a  <?php echo $dept_sort; ?>href="directory.php?<?php echo $qstr; ?>&sort=dept"><?php echo lang('department'); ?></a></th>
            <th width="180"><a  <?php echo $email_sort; ?>href="directory.php?<?php echo $qstr; ?>&sort=email"><?php echo lang('email_address'); ?></a></th>
            <th width="120"><a <?php echo $phone_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=phone"><?php echo lang('phone_number'); ?></a></th>
            <th width="80"><a <?php echo $ext_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=ext"><?php echo lang('phone_ext'); ?></a></th>
            <th width="120"><a <?php echo $mobile_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=mobile"><?php echo lang('mobile_number'); ?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php

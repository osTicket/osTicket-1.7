...
<div style="width:700;padding-top:5px; float:left;">
 <h2><?php echo _('Service Level Agreements');?></h2>
</div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
 <b><a href="slas.php?a=add" class="Icon newsla"><?php echo _('Add New SLA Plan');?></a></b></div>
<div class="clear"></div>
...
<input type="hidden" id="action" name="a" value="" >
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>        
            <th width="320"><a <?php echo $name_sort; ?> href="slas.php?<?php echo $qstr; ?>&sort=name"><?php echo _('Name');?></a></th>
            <th width="100"><a  <?php echo $status_sort; ?> href="slas.php?<?php echo $qstr; ?>&sort=status"><?php echo _('Status');?></a></th>
            <th width="130"><a  <?php echo $period_sort; ?> href="slas.php?<?php echo $qstr; ?>&sort=period"><?php echo _('Grace Period (hrs)');?></a></th>
            <th width="120" nowrap><a  <?php echo $created_sort; ?>href="slas.php?<?php echo $qstr; ?>&sort=created"><?php echo _('Date Added');?></a></th>
            <th width="150" nowrap><a  <?php echo $updated_sort; ?>href="slas.php?<?php echo $qstr; ?>&sort=updated"><?php echo _('Last Updated');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?php echo _('Are you sure want to <b>enable</b> selected SLA plans?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        <?php echo _('Are you sure want to <b>disable</b> selected SLA plans?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo _('Are you sure you want to DELETE selected SLA plans?');?></strong></font>
    </p>

...
//echo $query;
?>
<h2><?php echo _('Staff Members');?></h2>
<div style="width:700; float:left;">
    <form action="staff.php" method="GET" name="filter">
     <input type="hidden" name="a" value="filter" >
        <select name="did" id="did">
             <option value="0">&mdash; <?php echo _('All Department');?> &mdash;</option>
             <?php
        ...
        <select name="gid" id="gid">
            <option value="0">&mdash; <?php echo _('All Groups');?> &mdash;</option>
             <?php
        ...
        <select name="tid" id="tid">
            <option value="0">&mdash; <?php echo _('All Teams');?> &mdash;</option>
             <?php
...
<div style="float:right;text-align:right;padding-right:5px;"><b><a href="staff.php?a=add" class="Icon newstaff"><?php echo _('Add New Staff');?></a></b></div>
<div class="clear"></div>
<?php
$res=db_query($query);
...
<form action="staff.php" method="POST" name="staff" >
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7px">&nbsp;</th>        
            <th width="200"><a <?php echo $name_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=name"><?php echo _('Name');?></a></th>
            <th width="100"><a <?php echo $username_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=username"><?php echo _('UserName');?></a></th>
            <th width="100"><a  <?php echo $status_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=status"><?php echo _('Status');?></a></th>
            <th width="120"><a  <?php echo $group_sort; ?>href="staff.php?<?php echo $qstr; ?>&sort=group"><?php echo _('Group');?></a></th>
            <th width="150"><a  <?php echo $dept_sort; ?>href="staff.php?<?php echo $qstr; ?>&sort=dept"><?php echo _('Department');?></a></th>
            <th width="100"><a <?php echo $created_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=created"><?php echo _('Created');?></a></th>
            <th width="145"><a <?php echo $login_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=login"><?php echo _('Last Login');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
        if($res && db_num_rows($res)):
            ...
            while ($row = db_fetch_array($res)) {
               ...
               <tr id="<?php echo $row['staff_id']; ?>">
                ...
                <td><?php echo $row['isactive']?_('Active'):'<b>'._('Locked').'</b>'; ?>&nbsp;<?php echo $row['onvacation']?'<small>(<i>'._('vacation').'</i>)</small>':''; ?></td>
...
<p class="centered" id="actions">
    ...
    &nbsp;&nbsp;
    <input class="button" type="submit" name="disable" value="<?php echo _('Lock');?>" >
    &nbsp;&nbsp;
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?php echo _('Are you sure want to <b>enable</b> (unlock) selected staff?');?>
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        <?php echo _('Are you sure want to <b>disable</b> (lock) selected staff?');?>
        <br><br><?php echo _("Locked staff won't be able to login to Staff Control Panel.");?>
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo _('Are you sure you want to DELETE selected staff?');?></strong></font>
        <br><br><?php echo _('Deleted staff CANNOT be recovered.');?>
    </p>

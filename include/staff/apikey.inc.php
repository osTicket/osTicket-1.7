    ...
    <thead>
        <tr>
            <th colspan="2">
                ...
                <em><?= _("API Key is autogenerated and unique per IP address.")?></em>
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $api->getKey(); ?> &nbsp;&nbsp;<em><?= _('Delete and re-add to change the key')?></em></td>
        </tr>
        <?php }else{ ?>
        <tr>
            <td width="180" class="required">
        ...
        <tr>
            <th colspan="2">
                <em><strong><?= _('Enabled Services') ?>:</strong> <?= _('Check applicable API services.') ?></em>
            </th>
        </tr>
        <tr>
            <td width="180">
            ...
            <td>
                <input type="checkbox" name="email_piping" value="1" checked="checked" disabled="disabled" >
                    <strong><?= _('Enable') ?></strong> <?= _('remote email piping.') ?>
            </td>
        </tr>
        <tr>
            <th colspan="2">

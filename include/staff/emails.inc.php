...
if($res && ($num=db_num_rows($res)))
    $showing=$pageNav->showing().' '._('emails');
else
    $showing=_('No emails found!');

?>
<div style="width:700;padding-top:5px; float:left;">
 <h2><?php echo _('Email Addresses');?></h2>
 </div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="emails.php?a=add" class="Icon newEmail"><?php echo _('Add New Email');?></a></b></div>
<div class="clear"></div>
<form action="emails.php" method="POST" name="emails">
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>        
            <th width="400"><a <?php echo $email_sort; ?> href="emails.php?<?php echo $qstr; ?>&sort=email"><?php echo _('Email');?></a></th>
            <th width="120"><a  <?php echo $priority_sort; ?> href="emails.php?<?php echo $qstr; ?>&sort=priority"><?php echo _('Priority');?></a></th>
            <th width="250"><a  <?php echo $dept_sort; ?> href="emails.php?<?php echo $qstr; ?>&sort=dept"><?php echo _('Department');?></a></th>
            <th width="110" nowrap><a  <?php echo $created_sort; ?>href="emails.php?<?php echo $qstr; ?>&sort=created"><?php echo _('Created');?></a></th>
            <th width="150" nowrap><a  <?php echo $updated_sort; ?>href="emails.php?<?php echo $qstr; ?>&sort=updated"><?php echo _('Last Updated');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
<p class="centered" id="actions">
    <input class="button" type="submit" name="delete" value="<?php echo _('Delete Email(s)');?>" >
</p>
<?php
endif;
?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo _('Are you sure you want to DELETE selected emails?');?></strong></font>
        <br><br><?php echo _('Deleted emails CANNOT be recovered.');?>
    </p>

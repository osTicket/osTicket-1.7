...
<div id="breadcrumbs">
    <a href="index.php"><?php echo _('All Categories');?></a>
...
<div class="article-meta"><span class="faded"><b><?php echo _('Help Topics');?>:</b></span>
    <?php echo ($topics=$faq->getHelpTopics())?implode(', ',$topics):' '; ?>
</div>
</p>
<hr>
<div class="faded">&nbsp;<?php echo _('Last updated').' '.Format::db_daydatetime($category->getUpdateDate()); ?></div>

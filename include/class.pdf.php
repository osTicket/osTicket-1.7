...
class Ticket2PDF extends FPDF
{
	...
	function Header() {
		...
		$this->SetX(200, 15);
		$this->Cell(0, 15, _("Support Ticket System"), 0, 1, 'R', 0);
		//$this->SetY(40);
        $this->SetXY(60, 25);
	...
	function Footer() {
		...
		$this->Cell(0, 7, _('Ticket printed by').' '.$thisstaff->getUserName().' on '.date('r'), 0, 0, 'L');
    ...
    function _print() {
        ...
        $this->SetFont('Arial', 'B', 11);
        $this->Cell($l, 7, _('Subject'), 1, 0, 'L', true);
        $this->SetFont('');
